...
function createEmptyCustomCatalog() {
  return { products: {}, inventory: {}, removedProducts: {}, removedInventory: {}, productOrder: {}, inventoryOrder: {} };
}
...
function normalizeCustomCatalog(customCatalog) {
  ...
  Object.keys(DFY_PRODUCT_CATEGORIES).forEach((categoryKey) => {
...
function getProductCategories() {
  ...
  return Object.fromEntries(
    Object.entries(DFY_PRODUCT_CATEGORIES).map(([categoryKey, category]) => [
      categoryKey,
      {
        ...category,
    ...
    Object.entries(DFY_INVENTORY_CATEGORIES).map(([categoryKey, category]) => [
      categoryKey,
      {
        ...
        seasons: Object.fromEntries(
          Object.entries(category.seasons).map(([seasonKey, season]) => [
            seasonKey,
            {
              ...season,
