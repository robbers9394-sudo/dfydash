...
function createEmptyCustomCatalog() {
  return { products: {}, inventory: {}, seasons: {}, removedProducts: {}, removedInventory: {}, productOrder: {}, inventoryOrder: {} };
}
    ...
    Object.entries(DFY_INVENTORY_CATEGORIES).map(([categoryKey, category]) => {
      ...
      return [categoryKey, {
        ...
        seasons: Object.fromEntries(
          Object.entries(mergedSeasons).map(([seasonKey, season]) => [
            seasonKey,
            {
              ...season,
...
function normalizeInventorySeasonKey(categoryKey, seasonKey, customCatalog = null) {
  ...
  return Object.prototype.hasOwnProperty.call(baseSeasons, seasonKey) || Object.prototype.hasOwnProperty.call(customSeasons, seasonKey)
    ? seasonKey
...
function getDefaultInventorySeasonKey(categoryKey, customCatalog = null) {
  return Object.keys(DFY_INVENTORY_CATEGORIES[categoryKey]?.seasons || {})[0]
    || Object.keys(customCatalog?.seasons?.[categoryKey] || {})[0]
    || "";
}
...
async function hydrateInventoryStateFromSupabase() {
  ...
  if (!data) {
    ...
    state.customCatalog = normalizeCustomCatalog(localInventoryState.customCatalog || state.customCatalog);
    if (localInventoryState.items.length || localInventoryState.transactions.length || hasCustomCatalogData(localInventoryState.customCatalog)) {
  ...
  if (pendingInventoryState) {
    ...
    state.customCatalog = normalizeCustomCatalog(pendingInventoryState.customCatalog);
...
async function upsertInventoryStateToSupabase(inventoryState, options = {}) {
  ...
  const payload = {
    ...
    meta: {
      ...
      customCatalog: normalizeCustomCatalog(inventoryState.customCatalog || state.customCatalog)
    }
  };
